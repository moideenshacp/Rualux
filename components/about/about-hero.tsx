  ...
  return (
    <section className="relative overflow-hidden bg-primary py-32 md:py-40">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,_rgba(212,175,55,0.3)_0%,_transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_60%,_rgba(212,175,55,0.2)_0%,_transparent_40%)]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            We are a passionate team of designers dedicated to transforming 
